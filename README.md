...
<p align="center">
	<a href="https://github.com/Myselfsure01/subs-check/releases"><img src="https://img.shields.io/github/v/release/Myselfsure01/subs-check?style=flat-square&include_prereleases&label=version" /></a>
	<a href="https://github.com/Myselfsure01/subs-check/releases"><img src="https://img.shields.io/github/downloads/Myselfsure01/subs-check/total.svg?style=flat-square" /></a>
	<a href="https://github.com/Myselfsure01/subs-check/issues"><img src="https://img.shields.io/github/issues-raw/Myselfsure01/subs-check.svg?style=flat-square&label=issues" /></a>
	<a href="https://github.com/Myselfsure01/subs-check/graphs/contributors"><img src="https://img.shields.io/github/contributors/Myselfsure01/subs-check?style=flat-square" /></a>
	<a href="https://github.com/Myselfsure01/subs-check/blob/master/LICENSE"><img src="https://img.shields.io/github/license/Myselfsure01/subs-check?style=flat-square" /></a>
</p>
...
> **⚠️ 注意：** 功能更新频繁，请查看最新的[配置文件](https://github.com/Myselfsure01/subs-check/blob/master/config/config.example.yaml)以获取最新功能。  
> **⚠️ 注意：** 如果想要查看功能更新，可以参照 [示例配置提交历史](https://github.com/Myselfsure01/subs-check/commits/master/config/config.example.yaml),这里有变动说明有更功能/逻辑更新
...
下载 [Releases](https://github.com/Myselfsure01/subs-check/releases) 中适合的版本，解压后直接运行即可。
...
[![Stargazers over time](https://starchart.cc/Myselfsure01/subs-check.svg?variant=adaptive)](https://starchart.cc/Myselfsure01/subs-check)
