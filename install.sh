#!/bin/sh
# subs-check 一键安装脚本 (alive-check 版)
# 兼容 bash / sh / dash
# 用法: curl -fsSL https://raw.githubusercontent.com/Myselfsure01/subs-check/master/install.sh | bash
#   或: wget -qO- https://raw.githubusercontent.com/Myselfsure01/subs-check/master/install.sh | bash
# 加速: bash <(curl -fsSL https://ghfast.top/https://raw.githubusercontent.com/Myselfsure01/subs-check/master/install.sh) https://ghfast.top/

set -e

# ============ 配置 ============
REPO="Myselfsure01/subs-check"
